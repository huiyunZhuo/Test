...
export default {
    ...
    methods: {
        ...
        goToGoodsinfo: function(goodsId){
            ...
            // 3.在click事件中，使用this.$router.push({name: xxx, params:{}})
            this.$router.push({name: 'goodsinfo', params: {id: goodsId}});//params中我们要传递对应的商品的id，所以我们定义了一个带参数的方法来获取
        }
    },
}
</script>   
